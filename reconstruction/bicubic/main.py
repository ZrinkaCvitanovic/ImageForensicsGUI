# source: https://github.com/cdsvitbhopal/ProjectArena-ML/tree/main/Image%20Upscaling%20using%20Bicubic%20Interpolation
import cv2
import numpy as np
import sys
import os
...
input_dir = os.path.dirname(input_file)
output_file = os.path.join(input_dir, os.path.splitext(os.path.basename(input_file))[0]+'_upscaled' + str(args.quality) + '.jpg')
