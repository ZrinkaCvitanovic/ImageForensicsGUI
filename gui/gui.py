...
tab1 = ttk.Frame(tabControl, relief=tk.GROOVE)
tab2 = ttk.Frame(tabControl, relief=tk.GROOVE)
tab3 = ttk.Frame(tabControl, relief=tk.GROOVE)
...
btn_ela = tk.Button(tab2, text='Start', command=ela)
